    ...
    return (
        ...
        <div id="wrapper">
            ...
            <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                {/*Sidebar - Brand*/}
                <Link className="sidebar-brand d-flex align-items-center justify-content-center" to="/donor-home">
                    <div className="sidebar-brand-text mx-3">Кабінет донора</div>
                </Link>

                <hr className="sidebar-divider my-0" />

                <li className="nav-item active">
                    <Link className="nav-link" to="/donor-home">
                ...
                <li className="nav-item active">
                    <Link className="nav-link" to="/donor-home">
                        ...
                        <span>Запити від клінік</span>
                    </Link>
                </li>
                <li className="nav-item active">
                    <a className="nav-link" href="/donor/donate-blood">
                        <i className="fas fa-fw fa-comment-dots"></i>
                        <span>Запис на здачу крові</span></a>
                </li>
                <li className="nav-item active">
                    <Link className="nav-link" to="/donor/donation-history">
                        <i className="fas fa-fw fa-comment-dots"></i>
                        <span>Мої донації</span>
                    </Link>
                </li>
                ...
                <li className="nav-item active">
                    <Link className="nav-link" to="/donor-profile">
                        <i className="fas fa-fw fa-comment-dots"></i>
